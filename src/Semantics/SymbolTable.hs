...
instance PrettyVal SymDeclAug where
    ...
    prettyVal (SymDeclAug (WhileDecl cond body, SymData scp _)) =
        Con "WhileDecl" [String $ show scp, Con "Condition" [prettyVal $ SymExprAug cond], Con "Body" [prettyVal $ SymDeclAug body]]
