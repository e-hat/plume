...
data Memory = Register Int | Stack Int | ParamRegister Int | Global Int
...
replaceWithStackRead _ (T.Subs (T.Global globalId typ)) = MemoryLoc typ $ Global globalId
